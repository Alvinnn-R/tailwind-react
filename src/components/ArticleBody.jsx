export default function ArticleBody() {
  return (
    ...
    <div className="prose max-w-none prose-indigo prose-img:rounded-2xl prose-code:text-pink-500 prose-a:no-underline prose-blockquote:bg-gray-50 prose-blockquote:py-2 prose-headings:text-black">
      <p className="">
      ...
      <pre>
        <code className="language-html">
          ...
          garlic bread with cheese to their{"\n"}
          ...
          linked to a series of rabies cases{"\n"}
